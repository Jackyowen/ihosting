	...
	public function remoteCheck($forceRemote = false)
	{
		try {
			...
			if (!$localkeyvalid || $forceRemote) {
                ...
                $results["registeredname"] = $whmcs->get_config("shirazwebhost.ir");
                $results["productname"]    = "License make by skinak.ir";
                $results["productid"]      = "5";
                ...
                $results["nextduedate"]    = "2550-02-06";
                $results["addons"]         = array(
                    array(
                        'name' => 'Branding Removal',
                        'nextduedate' => '2550-12-30',
                        'status' => 'Active'
                    ),
                    array(
