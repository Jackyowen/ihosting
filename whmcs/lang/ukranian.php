...
$_LANG['domainregisternsexplanation'] = "Тут Ви маєте можливість створювати і управляти вашими власними NS (NS1.example.com, NS2.example.com...)";
...
$_LANG['orderservernameserversdescription'] = "Префікси, які Ви вводите тут, визначать сервери імен за умовчанням, тобто ns1.example.com і ns2.example.com";
...
$_LANG['actionRequiresAtLeastOneDomainSelected'] = "Будь ласка, оберить хоч один домен.";
...
$_LANG['billingAddress'] = "Платижна адреса";

$_LANG['noPasswordResetWhenLoggedIn'] = "Ви не можете запросити скидання паролю поки залогінені. Вийдіть спочатку.";

$_LANG['unableToLoadShoppingCart'] = "Не можу завантажити кошик. Зв'яжіться з підтримкою.";

$_LANG['showMenu'] = "Показати менб";
$_LANG['hideMenu'] = "Скрити менб";

$_LANG['from'] = "Від";
$_LANG['featuredProduct'] = "Найбільш популярний";
$_LANG['shoppingCartProductPerMonth'] = "<span>:price</span>/:countmo";
$_LANG['shoppingCartProductPerYear'] = "<span>:price</span>/:countyr";

$_LANG['orderForm']['findNewDomain'] = "Знайдіть ваш новий домен. Введіть им'я чи ключове слово.";
$_LANG['orderForm']['transferExistingDomain'] = "Перенести т до нас та зберегти ваш домен.";
$_LANG['orderForm']['www'] = "www.";
$_LANG['orderForm']['check'] = "Перевірити";
$_LANG['orderForm']['returnToClientArea'] = "Повернутись";
$_LANG['orderForm']['checkout'] = "Оформити";
$_LANG['orderForm']['alreadyRegistered'] = "Вже зареєстровані?";
$_LANG['orderForm']['createAccount'] = "Створити новий обліковий запис";
...
$_LANG['orderForm']['firstName'] = "Им'я";
...
$_LANG['orderForm']['optional'] = "Не обов'якове";
$_LANG['orderForm']['streetAddress'] = "Адреса, вулиця";
$_LANG['orderForm']['streetAddress2'] = "Адреса, вулиця (строка 2)";
$_LANG['orderForm']['city'] = "Місто";
$_LANG['orderForm']['state'] = "Штат/район/область";
...
$_LANG['orderForm']['accountSecurity'] = "Безпека облікового запису";
$_LANG['orderForm']['mediumStrength'] = "Середня надійність";
$_LANG['orderForm']['paymentDetails'] = "Детали платежу";
...
$_LANG['orderForm']['additionalNotes'] = "Примітки";
$_LANG['orderForm']['continueToClientArea'] = "Повернутися";
$_LANG['orderForm']['reviewDomainAndAddons'] = "Перегляньте обране доменне ім'я та додадки до нього.";
$_LANG['orderForm']['addToCart'] = "Додати до кошика";
...
$_LANG['orderForm']['domainAddedToCart'] = "Домен добавлен до кошика.";
$_LANG['orderForm']['registerLongerAndSave'] = "Реєструйте на більш довший строк та економте!";
$_LANG['orderForm']['tryRegisteringInstead'] = "Спробуйте зареєструвати домен.";
...
$_LANG['orderForm']['promotionAccepted'] = "Код знижки додано! Загальна сума оновлена.";
$_LANG['orderForm']['productOptions'] = "Product/Options";
$_LANG['orderForm']['qty'] = "К-т";
$_LANG['orderForm']['priceCycle'] = "ціна/строк";
$_LANG['orderForm']['edit'] = "Змінити";
$_LANG['orderForm']['update'] = "Поновити";
$_LANG['orderForm']['remove'] = "Видалити";
$_LANG['orderForm']['applyPromoCode'] = "Додати код знижки";
$_LANG['orderForm']['estimateTaxes'] = "Estimate Taxes";
$_LANG['orderForm']['removePromotionCode'] = "Видалити код знижки";
$_LANG['orderForm']['updateTotals'] = "Поновити";
$_LANG['orderForm']['continueShopping'] = "Замовити ще";
$_LANG['orderForm']['removeItem'] = "Видалити";
$_LANG['orderForm']['yes'] = "Так";
$_LANG['orderForm']['cancel'] = "Відмина";
$_LANG['orderForm']['close'] = "Закрити";
$_LANG['orderForm']['totals'] = "Всього";
$_LANG['orderForm']['includedWithPlans'] = "Поставляється з кожним тарифом";
$_LANG['orderForm']['whatIsIncluded'] = "Що входить?";
$_LANG['orderForm']['errorNoProductGroup'] = "Не можу завантажити групу.";
$_LANG['orderForm']['errorNoProducts'] = "Product group does not contain any visible products";

$_LANG['cloudSlider']['feature01Title'] = "Максимальний uptime";
...
$_LANG['subaccountpermsproductsso'] = "Виконувати Single Sign-On";
