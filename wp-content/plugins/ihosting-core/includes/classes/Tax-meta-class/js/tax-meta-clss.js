...
jQuery(document).ready(function($) {
  ...
  */
  ...
  //var type = $("select[name='kt_cat_type'] :selected").val();
  typeShow($("select[name='kt_cat_type'] :selected").val());
  $('select[name="kt_cat_type"]').change(function(e) {
    typeShow($(this).val());
    // this line gives me the value after the change event.
    //var inputUserRoles = $(this).val();
  });
  function typeShow(value){
    $("[class^='kt_cat_category']").hide();
    $(".kt_cat_category_"+value).show();
  }
  /**
   * Datepicker Field.
   *
