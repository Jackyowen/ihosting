...
// ANIMATION EFFECT
// -----------------------------------------------------------------------------------------------------------
global $kt_vc_anim_effects_in, $vc_setting_row, $vc_setting_row_inner, $ts_vc_anim_effects_out, $kt_vc_animate_effects;

$vc_setting_row = array(
	array(
		'type'        => 'checkbox',
		'class'       => '',
		'heading'     => esc_html__( 'Equal columns', 'ihosting-core' ),
		'param_name'  => 'equal_columns',
		'value'       => 'yes',
		'description' => esc_html__( 'If checked columns inner row will be alway equal heights.', 'ihosting-core' ),
	),
);
$vc_setting_row_inner = $vc_setting_row;

$ts_vc_anim_effects_out = array(
	esc_html__( '--- No Animation ---', 'ihosting-core' ) => '',
	esc_html__( 'bounceOut', 'ihosting-core' )            => 'bounceOut',
	esc_html__( 'bounceOutDown', 'ihosting-core' )        => 'bounceOutDown',
	esc_html__( 'bounceOutLeft', 'ihosting-core' )        => 'bounceOutLeft',
	esc_html__( 'bounceOutRight', 'ihosting-core' )       => 'bounceOutRight',
	esc_html__( 'bounceOutUp', 'ihosting-core' )          => 'bounceOutUp',
	esc_html__( 'fadeOut', 'ihosting-core' )              => 'fadeOut',
	esc_html__( 'fadeOutDown', 'ihosting-core' )          => 'fadeOutDown',
	esc_html__( 'fadeOutDownBig', 'ihosting-core' )       => 'fadeOutDownBig',
	esc_html__( 'fadeOutLeft', 'ihosting-core' )          => 'fadeOutLeft',
	esc_html__( 'fadeOutLeftBig', 'ihosting-core' )       => 'fadeOutLeftBig',
	esc_html__( 'fadeOutRight', 'ihosting-core' )         => 'fadeOutRight',
	esc_html__( 'fadeOutRightBig', 'ihosting-core' )      => 'fadeOutRightBig',
	esc_html__( 'fadeOutUp', 'ihosting-core' )            => 'fadeOutUp',
	esc_html__( 'fadeOutUpBig', 'ihosting-core' )         => 'fadeOutUpBig',
	esc_html__( 'flipOutX', 'ihosting-core' )             => 'flipOutX',
	esc_html__( 'flipOutY', 'ihosting-core' )             => 'flipOutY',
	esc_html__( 'lightSpeedOut', 'ihosting-core' )        => 'lightSpeedOut',
	esc_html__( 'rotateOut', 'ihosting-core' )            => 'rotateOut',
	esc_html__( 'rotateOutDownLeft', 'ihosting-core' )    => 'rotateOutDownLeft',
	esc_html__( 'rotateOutDownRight', 'ihosting-core' )   => 'rotateOutDownRight',
	esc_html__( 'rotateOutUpLeft', 'ihosting-core' )      => 'rotateOutUpLeft',
	esc_html__( 'rotateOutUpRight', 'ihosting-core' )     => 'rotateOutUpRight',
	esc_html__( 'slideOutUp', 'ihosting-core' )           => 'slideOutUp',
	esc_html__( 'slideOutDown', 'ihosting-core' )         => 'slideOutDown',
	esc_html__( 'slideOutLeft', 'ihosting-core' )         => 'slideOutLeft',
	esc_html__( 'slideOutRight', 'ihosting-core' )        => 'slideOutRight',
	esc_html__( 'zoomOut', 'ihosting-core' )              => 'zoomOut',
	esc_html__( 'zoomOutDown', 'ihosting-core' )          => 'zoomOutDown',
	esc_html__( 'zoomOutLeft', 'ihosting-core' )          => 'zoomOutLeft',
	esc_html__( 'zoomOutRight', 'ihosting-core' )         => 'zoomOutRight',
	esc_html__( 'zoomOutUp', 'ihosting-core' )            => 'zoomOutUp',
	esc_html__( 'rollOut', 'ihosting-core' )              => 'rollOut',
	esc_html__( 'hinge', 'ihosting-core' )                => 'hinge',
);

$kt_vc_anim_effects_in = array(
	esc_html__( '--- No Animation ---', 'ihosting-core' ) => '',
	esc_html__( 'bounce', 'ihosting-core' )               => 'bounce',
	esc_html__( 'flash', 'ihosting-core' )                => 'flash',
	esc_html__( 'pulse', 'ihosting-core' )                => 'pulse',
	esc_html__( 'rubberBand', 'ihosting-core' )           => 'rubberBand',
	esc_html__( 'shake', 'ihosting-core' )                => 'shake',
	esc_html__( 'swing', 'ihosting-core' )                => 'swing',
	esc_html__( 'tada', 'ihosting-core' )                 => 'tada',
	esc_html__( 'wobble', 'ihosting-core' )               => 'wobble',
	esc_html__( 'jello', 'ihosting-core' )                => 'jello',
	esc_html__( 'bounceIn', 'ihosting-core' )             => 'bounceIn',
	esc_html__( 'bounceInDown', 'ihosting-core' )         => 'bounceInDown',
	esc_html__( 'bounceInLeft', 'ihosting-core' )         => 'bounceInLeft',
	esc_html__( 'bounceInRight', 'ihosting-core' )        => 'bounceInRight',
	esc_html__( 'bounceInUp', 'ihosting-core' )           => 'bounceInUp',
	esc_html__( 'fadeIn', 'ihosting-core' )               => 'fadeIn',
	esc_html__( 'fadeInDown', 'ihosting-core' )           => 'fadeInDown',
	esc_html__( 'fadeInDownBig', 'ihosting-core' )        => 'fadeInDownBig',
	esc_html__( 'fadeInLeft', 'ihosting-core' )           => 'fadeInLeft',
	esc_html__( 'fadeInLeftBig', 'ihosting-core' )        => 'fadeInLeftBig',
	esc_html__( 'fadeInRight', 'ihosting-core' )          => 'fadeInRight',
	esc_html__( 'fadeInRightBig', 'ihosting-core' )       => 'fadeInRightBig',
	esc_html__( 'fadeInUp', 'ihosting-core' )             => 'fadeInUp',
	esc_html__( 'fadeInUpBig', 'ihosting-core' )          => 'fadeInUpBig',
	esc_html__( 'flip', 'ihosting-core' )                 => 'flip',
	esc_html__( 'flipInX', 'ihosting-core' )              => 'flipInX',
	esc_html__( 'flipInY', 'ihosting-core' )              => 'flipInY',
	esc_html__( 'lightSpeedIn', 'ihosting-core' )         => 'lightSpeedIn',
	esc_html__( 'rotateIn', 'ihosting-core' )             => 'rotateIn',
	esc_html__( 'rotateInDownLeft', 'ihosting-core' )     => 'rotateInDownLeft',
	esc_html__( 'rotateInDownRight', 'ihosting-core' )    => 'rotateInDownRight',
	esc_html__( 'rotateInUpLeft', 'ihosting-core' )       => 'rotateInUpLeft',
	esc_html__( 'rotateInUpRight', 'ihosting-core' )      => 'rotateInUpRight',
	esc_html__( 'slideInUp', 'ihosting-core' )            => 'slideInUp',
	esc_html__( 'slideInDown', 'ihosting-core' )          => 'slideInDown',
	esc_html__( 'slideInLeft', 'ihosting-core' )          => 'slideInLeft',
	esc_html__( 'slideInRight', 'ihosting-core' )         => 'slideInRight',
	esc_html__( 'zoomIn', 'ihosting-core' )               => 'zoomIn',
	esc_html__( 'zoomInDown', 'ihosting-core' )           => 'zoomInDown',
	esc_html__( 'zoomInLeft', 'ihosting-core' )           => 'zoomInLeft',
	esc_html__( 'zoomInRight', 'ihosting-core' )          => 'zoomInRight',
	esc_html__( 'zoomInUp', 'ihosting-core' )             => 'zoomInUp',
	esc_html__( 'rollIn', 'ihosting-core' )               => 'rollIn',
);

$kt_vc_animate_effects = array(
	esc_html__( '--- No Animation ---', 'ihosting-core' ) => '',
	esc_html__( 'bounce', 'ihosting-core' )               => 'bounce',
	esc_html__( 'flash', 'ihosting-core' )                => 'flash',
	esc_html__( 'pulse', 'ihosting-core' )                => 'pulse',
...
$ts_border_styles = array(
	esc_html__( 'Solid', 'ihosting-core' )  => 'solid',
	esc_html__( 'Dotted', 'ihosting-core' ) => 'dotted',
	esc_html__( 'Dashed', 'ihosting-core' ) => 'dashed',
	esc_html__( 'None', 'ihosting-core' )   => 'none',
	esc_html__( 'Hidden', 'ihosting-core' ) => 'hidden',
	esc_html__( 'Double', 'ihosting-core' ) => 'double',
	esc_html__( 'Groove', 'ihosting-core' ) => 'groove',
	esc_html__( 'Ridge', 'ihosting-core' )  => 'ridge',
	esc_html__( 'Inset', 'ihosting-core' )  => 'inset',
	esc_html__( 'Outset', 'ihosting-core' ) => 'outset',
);


if ( !function_exists( 'lk_iconpicker_build_param' ) ) {
	function lk_iconpicker_build_param( $settings = array() ) {

		$settings_default = array(
			'list_of_icons'        => array(
				esc_html__( 'Font Awesome', 'ihosting-core' )     => 'fontawesome',
				esc_html__( 'Open Iconic', 'ihosting-core' )      => 'openiconic',
				esc_html__( 'Typicons', 'ihosting-core' )         => 'typicons',
				esc_html__( 'Entypo', 'ihosting-core' )           => 'entypo',
				esc_html__( 'Linecons', 'ihosting-core' )         => 'linecons',
				esc_html__( 'Mono Social', 'ihosting-core' )      => 'monosocial',
				esc_html__( 'Flaticon', 'ihosting-core' )         => 'lkflaticon', // For Lucky Shop
				esc_html__( 'Pe Icon 7 Stroke', 'ihosting-core' ) => 'peicon7stroke', // For Lucky Shop
			),
			'icon_type_param_name' => 'icon_type',
			'icon_chosen_heading'  => esc_html__( 'Icon', 'ihosting-core' ),
			'icon_desc'            => esc_html__( 'Select icon from library.', 'ihosting-core' ),
		);
		...
		if ( !empty( $settings ) ) {
			$icon_param[] = array(
				'type'        => 'dropdown',
				'heading'     => esc_html__( 'Icon library', 'ihosting-core' ),
				'value'       => $settings['list_of_icons'],
				'param_name'  => $settings['icon_type_param_name'],
				'std'         => 'lkflaticon', // For Lucky Shop
				'description' => esc_html__( 'Select icon library.', 'ihosting-core' ),
			);
...
// FONT ICONS
// -----------------------------------------------------------------------------------------------------------
add_filter( 'vc_iconpicker-type-lkflaticon', 'ihosting_core_vc_iconpicker_type_lkflaticon' );
function ihosting_core_vc_iconpicker_type_lkflaticon( $icons ) {
	$flaticon = array(
...
add_filter( 'vc_iconpicker-type-peicon7stroke', 'ihosting_core_vc_iconpicker_type_peicon7stroke' );
function ihosting_core_vc_iconpicker_type_peicon7stroke( $icons ) {
	$peicon7stroke = array(
