...
<?php if ($autohide): ?>
    <div>
        ...
        <div class="woof_auto_show woof_overflow_hidden" style="opacity: 0; height: 1px;">
            ...
            <div class="woof <?php if (!empty($sid)): ?>woof_sid woof_sid_<?php echo $sid ?><?php endif; ?>" <?php if (!empty($sid)): ?>data-sid="<?php echo $sid; ?>"<?php endif; ?> shortcode="<?php echo(isset($_REQUEST['woof_shortcode_txt']) ? $_REQUEST['woof_shortcode_txt'] : 'no_woof') ?>">
                ...
                {
                    echo do_shortcode('[no_woof_price_filter]');
                }
                ?>
                    ...
                    <?php if ($price_filter == 2): ?>
                        <div data-css-class="woof_price2_search_container" class="woof_price2_search_container woof_container">
                            ...
                            <div class="woof_container_inner">
                                ...
                                <?php echo do_shortcode('[no_woof_price_filter additional_taxes="' . $additional_taxes . '"]'); ?>
