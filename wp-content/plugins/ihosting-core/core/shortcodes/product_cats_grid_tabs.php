...
function lk_get_product_tab_fields() {
	...
	for ( $i = 1; $i <= 8; $i++ ) {
		...
		$tab_fields[] = array(
			...
			array(
				'type'        => 'autocomplete',
				'heading'     => esc_html__( 'Categories', 'ihosting-core' ),
				'param_name'  => 'cat_slugs_' . $i,
				'settings'    => array(
					'multiple' => true,
					'sortable' => true,
				),
				'save_always' => true,
				'std'         => '',
				'description' => esc_html__( 'Input product categories ID or product title to see suggestions.', 'ihosting-core' ),
				'dependency'  => array(
					'element' => 'num_of_tabs',
					'value'   => $dep_array,
				),
			...
			array(
				'type'        => 'colorpicker',
				'class'       => '',
				'heading'     => esc_html__( 'Category Title Color', 'ihosting-core' ),
				'description' => esc_html__( 'Color of category name', 'js_composer' ),
				'param_name'  => 'cat_name_color_' . $i,
				'std'         => '#333',
				'dependency'  => array(
					'element' => 'num_of_tabs',
					'value'   => $dep_array,
			...
			array(
				'type'        => 'colorpicker',
				'class'       => '',
				'heading'     => esc_html__( 'Category description color', 'ihosting-core' ),
				'description' => esc_html__( 'Color of category description', 'js_composer' ),
				'param_name'  => 'cat_desc_color_' . $i,
				'std'         => '#666',
				'dependency'  => array(
					'element' => 'num_of_tabs',
					'value'   => $dep_array,
...
add_action( 'vc_before_init', 'lkProductsCatsGridTabs' );
function lkProductsCatsGridTabs() {
	...
	$tab_fields = lk_get_product_tab_fields();

	$vc_map = array(
		'name'     => esc_html__( 'LK Products Categories Grid Tabs', 'ihosting-core' ),
		'base'     => 'lk_products_cats_grid_tabs', // shortcode
		'class'    => '',
		...
		'params'   => array(
			...
			array(
				...
				'std'         => uniqid( 'product-cats-grid-tabs_' ),
				'description' => esc_html__( 'Enter product categories grid tab ID (Note: make sure it is unique and valid according to w3c specification).', 'ihosting-core' ),
			),
			array(
				'type'       => 'dropdown',
				'holder'     => 'div',
...
add_filter( 'vc_autocomplete_lk_products_cats_grid_tabs_cat_slugs_1_callback', 'ihosting_product_cat_autocomplete_suggester_by_slug', 10, 1 ); // Get suggestion(find). Must return an array
add_filter( 'vc_autocomplete_lk_products_cats_grid_tabs_cat_slugs_1_render', 'ihosting_product_cat_render_by_slug_exact', 10, 1 ); // Render exact category by id. Must return an array (label,value)
add_filter( 'vc_autocomplete_lk_products_cats_grid_tabs_cat_slugs_2_callback', 'ihosting_product_cat_autocomplete_suggester_by_slug', 10, 1 ); // Get suggestion(find). Must return an array
add_filter( 'vc_autocomplete_lk_products_cats_grid_tabs_cat_slugs_2_render', 'ihosting_product_cat_render_by_slug_exact', 10, 1 ); // Render exact category by id. Must return an array (label,value)
add_filter( 'vc_autocomplete_lk_products_cats_grid_tabs_cat_slugs_3_callback', 'ihosting_product_cat_autocomplete_suggester_by_slug', 10, 1 ); // Get suggestion(find). Must return an array
add_filter( 'vc_autocomplete_lk_products_cats_grid_tabs_cat_slugs_3_render', 'ihosting_product_cat_render_by_slug_exact', 10, 1 ); // Render exact category by id. Must return an array (label,value)
add_filter( 'vc_autocomplete_lk_products_cats_grid_tabs_cat_slugs_4_callback', 'ihosting_product_cat_autocomplete_suggester_by_slug', 10, 1 ); // Get suggestion(find). Must return an array
add_filter( 'vc_autocomplete_lk_products_cats_grid_tabs_cat_slugs_4_render', 'ihosting_product_cat_render_by_slug_exact', 10, 1 ); // Render exact category by id. Must return an array (label,value)
add_filter( 'vc_autocomplete_lk_products_cats_grid_tabs_cat_slugs_5_callback', 'ihosting_product_cat_autocomplete_suggester_by_slug', 10, 1 ); // Get suggestion(find). Must return an array
add_filter( 'vc_autocomplete_lk_products_cats_grid_tabs_cat_slugs_5_render', 'ihosting_product_cat_render_by_slug_exact', 10, 1 ); // Render exact category by id. Must return an array (label,value)
add_filter( 'vc_autocomplete_lk_products_cats_grid_tabs_cat_slugs_6_callback', 'ihosting_product_cat_autocomplete_suggester_by_slug', 10, 1 ); // Get suggestion(find). Must return an array
add_filter( 'vc_autocomplete_lk_products_cats_grid_tabs_cat_slugs_6_render', 'ihosting_product_cat_render_by_slug_exact', 10, 1 ); // Render exact category by id. Must return an array (label,value)
add_filter( 'vc_autocomplete_lk_products_cats_grid_tabs_cat_slugs_7_callback', 'ihosting_product_cat_autocomplete_suggester_by_slug', 10, 1 ); // Get suggestion(find). Must return an array
add_filter( 'vc_autocomplete_lk_products_cats_grid_tabs_cat_slugs_7_render', 'ihosting_product_cat_render_by_slug_exact', 10, 1 ); // Render exact category by id. Must return an array (label,value)
add_filter( 'vc_autocomplete_lk_products_cats_grid_tabs_cat_slugs_8_callback', 'ihosting_product_cat_autocomplete_suggester_by_slug', 10, 1 ); // Get suggestion(find). Must return an array
add_filter( 'vc_autocomplete_lk_products_cats_grid_tabs_cat_slugs_8_render', 'ihosting_product_cat_render_by_slug_exact', 10, 1 ); // Render exact category by id. Must return an array (label,value)

function lk_products_cats_grid_tabs( $atts ) {

	$atts = function_exists( 'vc_map_get_attributes' ) ? vc_map_get_attributes( 'lk_products_cats_grid_tabs', $atts ) : $atts;
	...
	$css_class = 'lk-products-cats-grid-tabs-wrap lk-tabs-floor-style wow ' . $css_animation;
	...
	for ( $i = 1; $i <= $num_of_tabs; $i++ ) {
		...
		$cat_slugs_param = 'cat_slugs_' . $i;
		$cat_name_color_param = 'cat_name_color_' . $i;
		$cat_desc_color_param = 'cat_desc_color_' . $i;
		...
		$cat_slugs = $$cat_slugs_param;
		$cat_name_color = $$cat_name_color_param;
		$cat_desc_color = $$cat_desc_color_param;
		...
		$tabs_content_html .= do_shortcode(
			'[lk_products_categories_grid 
				cat_slugs="' . esc_attr( $cat_slugs ) . '" 
				title_color="' . esc_attr( $cat_name_color ) . '" 
				desc_color="' . esc_attr( $cat_desc_color ) . '" 
...
add_shortcode( 'lk_products_cats_grid_tabs', 'lk_products_cats_grid_tabs' );
