<?php
/**
 * Mini Cart For Header Style: style_2, style_3
 *
	...
	<div class="header-view-cart-icon">
		<a title="<?php esc_html_e( 'View your shopping cart', 'ihosting' ); ?>"
		   ...
		   class="cart-link">
			...
			<span
				class="text"><?php echo ( $woocommerce->cart->cart_contents_count > 1 ) ? esc_html__( 'items', 'ihosting' ) : esc_html__( 'item', 'ihosting' ); ?></span>
			<span class="kak">-</span>
