...
add_action( 'tgmpa_register', 'ihosting_register_required_plugins' );
/**
 ...
 */
function ihosting_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			'name'               => 'iHosting Core', // The plugin name.
			'slug'               => 'ihosting-core', // The plugin slug (typically the folder name).
			'source'             => 'http://kute-themes.com/wordpress/vip-plugins/ihosting/ihosting-core.zip', // The plugin source.
		...
		array(
			...
			'source'       => 'http://kute-themes.com/wordpress/vip-plugins/plugins/js_composer/js_composer.zip', // The plugin source.
			'required'     => true, // If false, the plugin is only 'recommended' instead of required.
			'version'      => '4.11.2', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
			'external_url' => '', // If set, overrides default API URL and points to an external URL.
		),
		...
		array(
			...
			'source'       => 'http://kute-themes.com/wordpress/vip-plugins/plugins/revslider/revslider.zip', // The plugin source.
